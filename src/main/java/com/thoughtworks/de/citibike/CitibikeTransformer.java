...
public class CitibikeTransformer {
  ...
  public static void main(String[] args) {
    ...
    System.setProperty("hadoop.home.dir", "C:\\Users\\Asus\\Downloads\\hadoop-common-2.2.0-bin-master");
    SparkSession spark = SparkSession.builder().master("local").appName("Citibike Transformer").getOrCreate();
